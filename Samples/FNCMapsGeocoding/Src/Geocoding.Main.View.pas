...
uses
  ...
  VCL.TMSFNCMaps, VCL.TMSFNCGoogleMaps, VCL.TMSFNCCustomComponent, VCL.TMSFNCCloudBase, VCL.TMSFNCGeocoding;
...
begin
  ...
  TMSFNCGoogleMaps1.Service := TTMSFNCMapsService(cBoxService.ItemIndex);
...
begin
  TMSFNCGoogleMaps1.ClearMarkers;
end;

procedure TGeocodingMainView.TMSFNCGoogleMaps1MapClick(Sender: TObject; AEventData: TTMSFNCMapsEventData);
begin
  if ckGetReverseGeocodingByClickingMap.Checked then
    TMSFNCGeocoding1.GetReverseGeocoding(AEventData.Coordinate.ToRec);
end;

procedure TGeocodingMainView.TMSFNCGeocoding1GetReverseGeocodingResult(Sender: TObject;
...
var
 ...
 LEndAddress: TTMSFNCMapsCoordinateRec;
begin
  ...
  begin
    ...
    begin
      ...
      TMSFNCGoogleMaps1.SetCenterCoordinate(LStartAddress);
      TMSFNCGoogleMaps1.AddMarker(LStartAddress);
    ...
    begin
      LEndAddress := LGeocodingItem.Coordinate.ToRec;
      TMSFNCGoogleMaps1.AddMarker(LEndAddress);
    end;
  end;
end;
...
begin
  ...
  TMSFNCGoogleMaps1.ZoomToBounds(ACoordinateRec, ACoordinateRec);
  TMSFNCGoogleMaps1.SetZoomLevel(18);
end;
