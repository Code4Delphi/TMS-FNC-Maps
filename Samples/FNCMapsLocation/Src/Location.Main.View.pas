...
procedure TLocationMainView.FillcBoxServiceRoute;
var
...
procedure TLocationMainView.FillcBoxTravelMode;
var
...
procedure TLocationMainView.TMSFNCRouteCalculator1GetGeocoding(Sender: TObject;
...
procedure TLocationMainView.TMSFNCMaps1RouteCalculatorBeforeDeleteMarker(Sender: TObject;
...
procedure TLocationMainView.TMSFNCMaps1RouteCalculatorBeforeDeletePolyline(Sender: TObject;
...
procedure TLocationMainView.btClearClick(Sender: TObject);
begin
  TMSFNCMaps1.Clear;
  TMSFNCRouteCalculator1.Clear;
end;

procedure TLocationMainView.btDeleteClick(Sender: TObject);
begin
...
procedure TLocationMainView.btUndoClick(Sender: TObject);
begin
...
procedure TLocationMainView.btRedoClick(Sender: TObject);
begin
...
procedure TLocationMainView.btExportClick(Sender: TObject);
var
...
procedure TLocationMainView.btImportClick(Sender: TObject);
begin
...
procedure TLocationMainView.btnCalculateRouteBetweenAddressClick(Sender: TObject);
begin
